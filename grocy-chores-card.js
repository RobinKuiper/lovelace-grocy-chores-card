              ...
              ${this.chores.filter(chore => {
                ...
                <div class="info flex">
                  <div>
                    ...
                    ${this.config.custom_translation != null && this.config.custom_translation.due != null ? chore.dueInDays : chore.dueInDays/*this.config.custom_translation.due : "Due"*/}: <span class="${chore._next_estimated_execution_time != null ? this.checkDueClass(chore.dueInDays) : ""}">${chore._next_estimated_execution_time != null ? this.formatDueDate(chore._next_estimated_execution_time, chore.dueInDays) : "-"}</span>
                    </div>` : ""}
